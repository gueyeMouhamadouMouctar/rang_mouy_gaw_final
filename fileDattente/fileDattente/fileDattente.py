...
class Client:
	...
	"""
		Methode publique pour recuperer le numero de ticket du client
	"""
	def getNumber(self):
		return self.number
	...
	"""
		Methode publique d'auto-insertion du client courant dans la file d'attente. La téte de file lui est transmise en parametre
	"""
...
class PregnantClient(Client):
	...
	"""
		Redefinition de la methode publique d'affichage d'une cliente en état de grossesse
	"""
	def show(self):
		# On récupére le numéro du client courant
